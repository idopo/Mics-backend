...
Plans:
- [ ] 35-01-PLAN.md — Wave 1 — dlc_link package foundation: the ONE bodypart-name transform (indices from an explicit pose order) and the deadband + Hz-cap decimator (DLC-02, DLC-04, DLC-13)
- [ ] 35-02-PLAN.md — Wave 1 — liveness debt, OFFLINE half: the cross-clock analysis, the canonical liveness_hook, and a candidate lib 177 v3 (DLC-06)
